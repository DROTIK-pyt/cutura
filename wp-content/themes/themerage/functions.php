<?php
/**
 * themerage functions and definitions
 *
 ...
 */
function themerage_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on themerage, use a find and replace
		* to change 'themerage' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'themerage', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'themerage_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'themerage_setup' );
 ...
 */
function themerage_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'themerage_content_width', 640 );
}
add_action( 'after_setup_theme', 'themerage_content_width', 0 );
 ...
 */
function themerage_widgets_init() {
	register_sidebar(
		array(
...
add_action( 'widgets_init', 'themerage_widgets_init' );
